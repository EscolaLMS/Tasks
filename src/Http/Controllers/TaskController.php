...
class TaskController extends EscolaLmsBaseController
{
    ...
    public function create(CreateTaskRequest $request): JsonResponse
    {
        ...
        return $this->sendResponseForResource(TaskResource::make($task), 'User task created successfully.');
    }
    ...
    public function update(UpdateTaskRequest $request): JsonResponse
    {
        ...
        return $this->sendResponseForResource(TaskResource::make($task), 'User task updated successfully.');
    }
    ...
    public function complete(CompleteTaskRequest $request): JsonResponse
    {
        ...
        return $this->sendResponseForResource(TaskResource::make($task), 'User task complete successfully.');
    }
    ...
    public function incomplete(IncompleteTaskRequest $request): JsonResponse
    {
        ...
        return $this->sendResponseForResource(TaskResource::make($task), 'User task incomplete successfully.');
    }
